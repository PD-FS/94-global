...
class ReportTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create report_type" do
    assert_difference('ReportType.count') do
      post report_types_url, params: { report_type: { name: @report_type.name, picture: @report_type.picture, report_category_id: @report_type.report_category_id, report_class_id: @report_type.report_class_id } }
    end
  ...
  test "should update report_type" do
    patch report_type_url(@report_type), params: { report_type: { name: @report_type.name, picture: @report_type.picture, report_category_id: @report_type.report_category_id, report_class_id: @report_type.report_class_id } }
