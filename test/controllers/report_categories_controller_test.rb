...
class ReportCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create report_category" do
    assert_difference('ReportCategory.count') do
      post report_categories_url, params: { report_category: { icon: @report_category.icon, name: @report_category.name } }
    end
  ...
  test "should update report_category" do
    patch report_category_url(@report_category), params: { report_category: { icon: @report_category.icon, name: @report_category.name } }
